                ...
                <div class="col-lg-2 left-nav" >
                    <ul class="list-group"> 
                        ...
                        <li class="list-group-item " id="DemandeCollapse">
                                <ul>
                                    <li class="actived"><a href="demande.php">Non valide</a></li>
                            ...
                            <table  class="table border">
                                    ...
                                    echo    '<tr><td ><a href="userdetail.php">'.$ud[$i][5].' '.$ud[$i][4].'</a></td>';
                                            ...
                                            echo '<td class="float-right">';
                                                echo'<button type="button" onclick="validdem('.$ud[$i][0].')" class="btn btn-primary btn-sm "><i class="fa fa-arrow-right"></i></button>';
                                      ...
                                      $data=$dr->getSentDemandByIdd($ud[$i][0]);
                                      $bill= $dr->getBillByDemand($ud[$i][0])[0];    
