                    ...
                    <ul class="list-group"> 
                        ...
                        <li class="list-group-item " id="DemandeCollapse">
                                <ul>
                                    ...
                                    <li class="actived"><a href="demandeencour.php"> En cours</a></li>
                            ...
                            <table  class="table border">
                                    ...
                                    echo    '<tr><td ><a href="userdetail.php">'.$ud[$i][5].' '.$ud[$i][4].'</a></td>';
                                            ...
                                            echo '<td class="float-right">';
                                                echo'<button type="button" onclick="compdem('.$ud[$i][0].')" class="btn btn-success btn-sm "><i class="fa fa-check"></i></button>';
                                      ...
                                      $data=$dr->getValidDemandByIdd($ud[$i][0]);
