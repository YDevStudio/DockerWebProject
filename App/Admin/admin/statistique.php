                ...
                <div class="col-lg-2 left-nav" >
                    <ul class="list-group"> 
                        ...
                        <li class="list-group-item " id="StatistiqueCollapse">
                                <ul>
                                    <li class="actived"><a href="statistique.php">Produit</a></li>
                        ...
                        <div class="table-wrapper-scroll-y my-custom-scrollbar">
                            <table class="table border">
                                ...
                                <tr>
                                    <th>ID</th>
                                    <th>NOM</th>
                                    <th style='color: #ffff00'>Hovers</th>
                                    <th style='color: #ffff00'>Visiteurs</th>
                                    <th><i class="fas fa-heartfas fa-heart" style='color: #ff4d4d'></i></th>

                                    <th style='color:#1aff66'>En cour</th>
                                    <th style='color:#1aff66'>Valide</th>

                                </tr>
                                <?php
                                for($i=0;$i<count($p);$i++){
                                echo '<tr><td>Px'.(intval($p[$i][0])*3+173) .'</td>';
                                    echo '<td >'.$p[$i][1].'</td>';
                                    echo '<td class="classbgcolor2">'.$p[$i][2].'</td>';
                                    echo '<td class="classbgcolor2">'.$p[$i][3].'</td>';
                                    echo '<td class="classbgcolor1">'.$Sr->pinList($p[$i][0]).'</td>';
                                    echo '<td class="classbgcolor3">'.$Sr->pinD0($p[$i][0]).'</td>';
                                    echo '<td class="classbgcolor3">'.$Sr->pinD1($p[$i][0]).'</td></tr>';
