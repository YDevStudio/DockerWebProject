            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 hearchy">
                        <a href="#"><i class="fa fa-home"></i></a> / <small > Développeurs du site </small>
                    </div>
                    
                    <div class="col-lg-12 developpers_title">
                        <h2>Développeurs du site</h2>
                    </div>
                    <div class="developpers_body ">
